...
class ResidualBlock(nn.Module):
    def __init__(self, inchannels, out_channels, stride=1):
        ...
        self.conv1 = nn.Conv2d(inchannels, out_channels, kernel_size=3, stride=stride, padding=1, bias=False)
        ...
        if stride != 1 or inchannels != out_channels:
            self.shortcut = nn.Sequential(nn.Conv2d(inchannels, out_channels, stride=stride, kernel_size=1, bias=False),
